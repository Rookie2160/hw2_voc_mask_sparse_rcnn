...
# 模型配置
mask_config_file = 'mask_rcnn_voc/mask-rcnn_r50_fpn_1x_voc.py'
mask_checkpoint_file = 'mask_rcnn_voc/best_coco_bbox_mAP_epoch_43.pth'
sparse_config_file = 'sparse_rcnn_voc/sparse-rcnn_r50_fpn_1x_coco.py'
sparse_checkpoint_file = 'sparse_rcnn_voc/20250520_083511/best_coco_bbox_mAP_epoch_98.pth'
#device = 'cuda:0'  # 或 'cpu'
device='cpu'
# 初始化模型
...
data_root = '/root/zrq/extra_photos'
imgs = [
    "boat.jpg",
    "bottle.jpg",
    "cat.jpg",
